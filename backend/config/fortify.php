...
return [
    ...
    */
    ...
    // Solo usamos el backend de 2FA de Fortify (trait + actions); sus rutas se apagan con Fortify::ignoreRoutes().
    // El resto de features (registro, reset, perfil) ya los maneja nuestro AuthController stateless.
    'features' => [
